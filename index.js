 ...
 */
function customAssign(...objects) {if (objects.length < 2)  {return "Помилка: Має бути передано принаймні два об'єкти.";}
objects.map((obj) => {
  for (let key in obj) {
 ...
 */
function customEntries(obj) {if (typeof obj !== "object" || obj === null) {
  return "Помилка: Аргумент не є об'єктом.";
} const entriesArray = Object.entries(obj); return entriesArray;
 ...
 */
function customObjectFromEntries(entries) {if (typeof entries !== "object" || entries === null) { return " Помилка: Вхідний аргумент має бути масивом.";}  
entries.map((obj) => {
    for (let key in obj) {
      if (typeof obj[key] === "number") {
        obj[key] = obj[key].toString();
...
function checkProperty(obj, prop) {if (typeof obj!== "object" || obj === null) { return ` false`;}  
if (typeof prop !== "string"){ return ` false`;}  const obj1=obj.hasOwnProperty(prop); return obj1;
...
function extendAndFreezeObject(obj1, obj2) {if (typeof obj1 !== "object" || obj1 === null, typeof obj2 !== "object" || obj2 === null ) { return ` null`;}
 const obj3=Object.assign(obj1,obj2); Object.freeze(obj3); if(Object.isFrozen(obj3)=== false){return `Помилка, об’єкт не заморожено`;}
 else if(Object.isFrozen(obj3)=== true){return obj3;}
...
function keysAndValues(obj) {if (typeof obj!== "object" || obj === null) { return ` null`;} const obj1= Object.keys(obj);
 const obj2= Object.values(obj); let obj3={obj1,obj2}; return obj3;
 ...
 */
function filterObjectsByKey(arr, key) {if(!Array.isArray(arr)){ return [] ;}  
const arr2=arr.filter(obj=>obj[key]); return arr2;
 ...
 */
function checkAndPreventExtensions(obj) {if (typeof obj!== "object" || obj === null) { return ` false`;}
if(Object.isExtensible(obj)=== false){ return  `false`, Object.preventExtensions(obj);}
else if(Object.isExtensible(obj)=== true){return obj;}
 ...
 */
function sealAndCheck(obj) {if (typeof obj!== "object" || obj === null) { return ` false`;}
 const obj1=Object.seal(obj); console.log(Object.isSealed(obj1));
  // Перевіряємо, чи вхідний параметр є об'єктом, якщо ні, повертаємо false
...
function checkOwnership(obj1, obj2, key) {if(obj1. hasOwnProperty(key)===true, obj2.hasOwnProperty(key)===true)
  { if(obj1[key]===obj2[key]) {return true} else{return false}} else return false;
 ...
 */
function getObjectValuesSum(obj) { if(typeof obj!== "object" || obj === null) { return 0;} 
const obj1= Object.values(obj);  const SumObj=obj1.reduce((accumulator, currentValue)=>accumulator+currentValue); return SumObj;
 ...
 */
function convertArrayToObj(arr) { if(!Array.isArray(arr)){ return {} ;} 
 const obj= {};  for (let i=0; i < arr.length; i++){ const [key, value] = arr[i];
if(obj.hasOwnProperty(key)){console.log( ` є дубльований ключ: ${key} `);} obj[key] = value;} 
